...
Specifies which tests will be run. Value "authentication" runs test which grade authentication endpoints. Following parameters are required:
    ...
    python main.py --type authentication --authentication-address http://127.0.0.1:5002 --jwt-secret JWT_SECRET_KEY --roles-field roles --administrator-role admin --customer-role buyer --warehouse-role storageworker
...
1) Value "level0" is used for running tests which grade endpoints that update (warehouse container) and search (customer container) products. Following parameters are supported:
    ...
    python main.py --type level0 --customer-address http://127.0.0.1:5003 --warehouse-address http://127.0.0.1:5004
    python main.py --type level0 --with-authentication --authentication-address http://127.0.0.1:5002 --customer-address http://127.0.0.1:5003 --warehouse-address http://127.0.0.1:5004
...
2) Value "level1" is used for running tests which grade endpoints that create orders (complete and pending) and retrieve their status. Following parameters are supported:
    ...
    python main.py --type level1 --with-authentication --authentication-address http://127.0.0.1:5002 --customer-address http://127.0.0.1:5003 --warehouse-address http://127.0.0.1:5004
...
3) Value "level2" is used for running tests which grade endpoints that update the status of certain products and orders (FIFO). Following parameters are supported:
    ...
    python main.py --type level2 --with-authentication --authentication-address http://127.0.0.1:5002 --customer-address http://127.0.0.1:5003 --warehouse-address http://127.0.0.1:5004
...
Value "all" is used for running all tests. Following parameters are required:
    ...
    python main.py --type all --with-authentication --authentication-address http://127.0.0.1:5002 --jwt-secret JWT_SECRET_KEY --roles-field roles --administrator-role admin --customer-role buyer --warehouse-role storageworker --customer-address http://127.0.0.1:5003 --warehouse-address http://127.0.0.1:5004 --administrator-address http://127.0.0.1:5005
